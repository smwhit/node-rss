...
var feed_url = "http://eppppp.tahvel.info/feed/";

var feed_url = "http://promoblogi.blogspot.com/feeds/posts/default";

var feed_url = "http://testetstetss.blogspot.com/feeds/posts/default";
...
console.log(item.getDate(),new Date(Date.now() - 4 * 24 * 3600 * 1000), item.getDate() < new Date(Date.now() - 4 * 24 * 3600 * 1000))        
